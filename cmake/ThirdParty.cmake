...
ExternalProject_Add(
  ...
  CMAKE_ARGS -DCMAKE_BUILD_TYPE=Release -DFMT_DOC=OFF -DFMT_INSTALL=OFF -DFMT_TEST=OFF -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER} -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER}
  INSTALL_COMMAND "")
